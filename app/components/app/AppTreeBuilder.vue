<template>
    <div class="flex">
        <div class="w-80 flex items-center gap-2 p-1 pl-3 rounded-lg border border-accented">
        ...
        <div class="flex flex-col gap-2 pl-2" v-if="generation <= 3">
            <div class="flex-1 relative">
                ...
                <AppTreeBuilder v-if="animal?.father" :animal="animal.father" :generation="generation + 1" @edit="emit('edit', $event)" @assignParent="emit('assignParent', $event)" @createParent="emit('createParent', $event)" />
            ...
            <div class="flex-1 relative">
                ...
                <AppTreeBuilder v-if="animal?.mother" :animal="animal.mother" :generation="generation + 1" @edit="emit('edit', $event)" @assignParent="emit('assignParent', $event)" @createParent="emit('createParent', $event)" />
                <UFieldGroup class="w-80" size="sm" v-else>
